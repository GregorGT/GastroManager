...
public class SecondChildFragment extends Fragment {
    ...
    private class LoadDrillDownMenuTask extends AsyncTask<Object, Void, String> {
        ...
        protected String doInBackground(Object... request) {
            ...
            String serverResponse = client.getResponse((String) Arrays.stream(request).findFirst().get());
